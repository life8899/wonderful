...
sig
  ...
  (*  Theorems  *)
    val aclExerciseOne : thm
    val aclExerciseOneA : thm
    val aclExerciseTwo : thm
    val aclExerciseTwoA : thm
    val aclExerciseTwoB : thm
